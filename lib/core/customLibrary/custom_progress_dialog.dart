...
enum CustomProgressDialogType { Normal, Download }
...
CustomProgressDialogType? _progressDialogType;
...
class CustomProgressDialog {
  ...
  CustomProgressDialog(BuildContext context,
      {CustomProgressDialogType? type,
        bool? isDismissible,
        bool? showLogs,
        TextDirection? textDirection,
        Widget? customBody}) {
    _context = context;
    _progressDialogType = type ?? CustomProgressDialogType.Normal;
  ...
  void style(
    ...
    if (_progressDialogType == CustomProgressDialogType.Download) {
...
class _BodyState extends State<_Body> {
  ...
  Widget build(BuildContext context) {
    ...
    final text = Expanded(
      child: _progressDialogType == CustomProgressDialogType.Normal
          ? Text(
        _dialogMessage,
